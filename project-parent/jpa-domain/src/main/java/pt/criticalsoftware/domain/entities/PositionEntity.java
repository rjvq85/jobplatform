...
@NamedQueries({ @NamedQuery(name = "Position.getAll", query = "SELECT u from PositionEntity u"),
		@NamedQuery(name = "Position.getPositionsByReference", query = "SELECT u from PositionEntity u WHERE u.reference = :reference  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByTitle", query = "SELECT u from PositionEntity u WHERE u.title = :title  ORDER BY u.openDate DESC"),
		...
		@NamedQuery(name = "Position.getPositionsByCompany", query = "SELECT u from PositionEntity u WHERE u.company = :company  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByTechnicalArea", query = "SELECT u FROM PositionEntity u WHERE u.technicalArea = :technicalArea  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByLocale", query = "SELECT u FROM PositionEntity u WHERE u.locale = :locale  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByLocaleAndArea", query = "SELECT u FROM PositionEntity u WHERE u.locale = :locale AND u.technicalArea = :technicalArea  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByDate", query = "SELECT u FROM PositionEntity u WHERE u.closeDate = :closeDate  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByOpenDate", query = "SELECT u FROM PositionEntity u WHERE u.openDate = :openDate ORDER BY u.openDate DESC"),
