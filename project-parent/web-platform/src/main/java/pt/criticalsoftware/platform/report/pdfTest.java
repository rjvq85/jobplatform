...
public class pdfTest implements Serializable {
	...
	private static final long serialVersionUID = -4052124962600418065L;
	...
	public String generatMain(ArrayList<IInterview> interviews, boolean file, String documentNumber){
		...
		try {
			...
			document.add(image);
			addTitlePage(document, documentNumber);
	...
	private void addTitlePage(Document document, String documentNumber)
