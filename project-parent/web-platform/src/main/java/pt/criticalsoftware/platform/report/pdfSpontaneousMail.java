...
@Named
@RequestScoped
public class pdfSpontaneousMail {
	...
	public String generatMain(ArrayList<ICandidacy> candidacies, String documentNumber){
		...
		String FILE = "candidaciesSpontaneous"+documentNumber+".pdf";
		try {
	...
	private void addTitlePage(Document document)
		...
		preface.add(new Paragraph("Relatório Candidaturas Espontaneas Por Período De Tempo", catFont));
