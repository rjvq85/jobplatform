package pt.criticalsoftware.service.style;
...
public class TextEJB {
	private final Logger logger = LoggerFactory.getLogger(TextEJB.class);
	...
	public void setSelectedText(String selectedText) {
		logger.info("entrou no set com valor" + selectedText);
