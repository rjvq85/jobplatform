...
@NamedQueries({ @NamedQuery(name = "Position.getAll", query = "SELECT u from PositionEntity u"),
		@NamedQuery(name = "Position.getPositionsByReference", query = "SELECT u from PositionEntity u WHERE u.reference = :reference AND p.state LIKE 'ABERTA' ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByTitle", query = "SELECT u from PositionEntity u WHERE u.title = :title AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByState", query = "SELECT u from PositionEntity u WHERE u.state = :state AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByCompany", query = "SELECT u from PositionEntity u WHERE u.company = :company AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByTechnicalArea", query = "SELECT u FROM PositionEntity u WHERE u.technicalArea = :technicalArea AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByLocale", query = "SELECT u FROM PositionEntity u WHERE u.locale = :locale AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByLocaleAndArea", query = "SELECT u FROM PositionEntity u WHERE u.locale = :locale AND u.technicalArea = :technicalArea AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByDate", query = "SELECT u FROM PositionEntity u WHERE u.closeDate = :closeDate AND p.state LIKE 'ABERTA'  ORDER BY u.openDate DESC"),
		@NamedQuery(name = "Position.getPositionsByOpenDate", query = "SELECT u FROM PositionEntity u WHERE u.openDate = :openDate AND p.state LIKE 'ABERTA' ORDER BY u.openDate DESC"),
